...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/08/20 15:52:50 by ktabe             #+#    #+#             */
/*   Updated: 2020/10/07 21:40:12 by kotatabe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				output_di(va_list ap, t_data *type)
{
	...
	i = 0;
	nega_flag = 0;
	if ((tmp = (long)va_arg(ap, int)) < 0)
	{
		tmp *= -1;
		nega_flag = 1;
	}
	type->length = nbrlen(tmp);
